...
<html lang="ja">
	<head>
		...
		<link rel="stylesheet" href="bookname.css">
	...
	<body>
		...
		<?php
		if(isset($_GET['bname'])==0 || $_GET['bname']==null || $_GET['pg']==0 || $_GET['pg']==null){
			...
			<script>
				...
				if(page == 1){
					if(json.Items.TotalPages != 1 && json.Items.TotalPages != 0){
						...
						document.write (\"<li style='margin-left:488px'><a href='./?pg=\"+ (page+1) +\"&bname=".$title."'>次の10冊 &raquo;</a></li>\");
						document.write (\"</ul>\");
					}
				}else if(page < Math.min(5,json.Items.TotalPages) && page > 1){
					document.write (\"<ul class='pageNav'>\");
					document.write (\"<li><a href='./?pg=\"+ (page-1) +\"&bname=".$title."'>&laquo; 前の10冊</a></li>\");
					document.write (\"<li style='margin-left:400px'><a href='./?pg=\"+ (page+1) +\"&bname=".$title."'>次の10冊 &raquo;</a></li>\");
					document.write (\"</ul>\");
				...
				document.write (\"<div id='bname_search_results'>\");
				if(item.length){
					for(var i=0;i<item.length;i++){
						if(item[i].ImageSets == null){
							image_m = '../../material/no_image_m.png';
							image_s = '../../material/no_image_s.png';
						}else{
							var imageset = item[i].ImageSets.ImageSet;
							if (imageset.length) imageset = imageset[0];
							image_m = imageset.MediumImage.URL;
							image_s = imageset.SmallImage.URL;
						}
						...
						document.write (\"<div class='b_register'>\
							<form action='../confirm/'' method='post'>\
								...
								<input type='hidden' name='author' value='hoge'>\
